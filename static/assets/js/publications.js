...
( function () {
    ...
    var cfg = {
        ...
        // ==========================================================
        halUrl: 'https://api.archives-ouvertes.fr/search/?q=structId_i:1548325+AND+authFullName_t:"Christophe Biernacki"&rows=500&fl=title_s,authFullName_s,producedDateY_i,journalTitle_s,abstract_s,uri_s&sort=producedDateY_i+desc&wt=json',
